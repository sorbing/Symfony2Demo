...
abstract class BaseTaskTag extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'App\\CommonBundle\\Model\\TaskTagPeer';
     ...
     * @return TaskTag The current object (for fluent API support)
     */
    public function setTaskId($v)
    {
        ...
        if ($this->task_id !== $v) {
            $this->task_id = $v;
            $this->modifiedColumns[] = TaskTagPeer::TASK_ID;
        }
    ...
    public function setTagId($v)
    {
        ...
        if ($this->tag_id !== $v) {
            $this->tag_id = $v;
            $this->modifiedColumns[] = TaskTagPeer::TAG_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->task_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 2; // 2 = TaskTagPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating TaskTag object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = TaskTagPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = TaskTagQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TaskTagPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TaskTagPeer::TASK_ID)) {
            $modifiedColumns[':p' . $index++]  = '`TASK_ID`';
        }
        if ($this->isColumnModified(TaskTagPeer::TAG_ID)) {
            $modifiedColumns[':p' . $index++]  = '`TAG_ID`';
        }

        $sql = sprintf(
            'INSERT INTO `task_tag` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = TaskTagPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = TaskTagPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['TaskTag'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['TaskTag'][serialize($this->getPrimaryKey())] = true;
        $keys = TaskTagPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TaskTagPeer::TASK_ID)) $criteria->add(TaskTagPeer::TASK_ID, $this->task_id);
        if ($this->isColumnModified(TaskTagPeer::TAG_ID)) $criteria->add(TaskTagPeer::TAG_ID, $this->tag_id);
    ...
    {
        $criteria = new Criteria(TaskTagPeer::DATABASE_NAME);
        $criteria->add(TaskTagPeer::TASK_ID, $this->task_id);
        $criteria->add(TaskTagPeer::TAG_ID, $this->tag_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getTaskId()) && (null === $this->getTagId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of TaskTag (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return TaskTag Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(TaskTagPeer::DEFAULT_STRING_FORMAT);
    }
