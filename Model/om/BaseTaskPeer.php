...
use App\CommonBundle\Model\map\TaskTableMap;
...
abstract class BaseTaskPeer
{
    ...
    const OM_CLASS = 'App\\CommonBundle\\Model\\Task';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Description', 'DueDate', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'description', 'dueDate', ),
        BasePeer::TYPE_COLNAME => array (TaskPeer::ID, TaskPeer::NAME, TaskPeer::DESCRIPTION, TaskPeer::DUE_DATE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'DESCRIPTION', 'DUE_DATE', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'description', 'due_date', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Description' => 2, 'DueDate' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'description' => 2, 'dueDate' => 3, ),
        BasePeer::TYPE_COLNAME => array (TaskPeer::ID => 0, TaskPeer::NAME => 1, TaskPeer::DESCRIPTION => 2, TaskPeer::DUE_DATE => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'DESCRIPTION' => 2, 'DUE_DATE' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'description' => 2, 'due_date' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    {
        // Invalidate objects in TaskTagPeer instance pool,
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            // delete related TaskTag objects
            $criteria = new Criteria(TaskTagPeer::DATABASE_NAME);

            $criteria->add(TaskTagPeer::TASK_ID, $obj->getId());
            $affectedRows += TaskTagPeer::doDelete($criteria, $con);
        }
