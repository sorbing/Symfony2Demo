...
class AuthorTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.App.CommonBundle.Model.map.AuthorTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('App\\CommonBundle\\Model\\Author');
    ...
    {
        $this->addRelation('Book', 'App\\CommonBundle\\Model\\Book', RelationMap::ONE_TO_MANY, array('id' => 'author_id', ), null, null, 'Books');
    } // buildRelations()
