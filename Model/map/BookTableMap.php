...
class BookTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.App.CommonBundle.Model.map.BookTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('App\\CommonBundle\\Model\\Book');
    ...
    {
        $this->addRelation('Author', 'App\\CommonBundle\\Model\\Author', RelationMap::MANY_TO_ONE, array('author_id' => 'id', ), null, null);
    } // buildRelations()
