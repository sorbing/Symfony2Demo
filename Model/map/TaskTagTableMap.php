...
/**
 * This class defines the structure of the 'task_tag' table.
 *
 *
 *
 ...
 */
class TaskTagTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src.App.CommonBundle.Model.map.TaskTagTableMap';
    ...
    {
        // attributes
        $this->setName('task_tag');
        $this->setPhpName('TaskTag');
        $this->setClassname('App\\CommonBundle\\Model\\TaskTag');
